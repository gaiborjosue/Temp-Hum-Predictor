...
hum_predictor = joblib.load('Predicciones_Finales\\Models\\4th_release\\hum_predictor.joblib')
...
predict_hum = hum_predictor.predict([temp_field_data])

predicted_value = int(predict_hum[0][0])
real_value = int(float(hum_field_data[0]))
